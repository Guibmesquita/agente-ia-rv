export const unitsData = [
  ...
  { sigla: 'CBA', nome: 'Cuiabá', x: 45, y: 52 },
  ...
  { sigla: 'DGT CTB', nome: 'Curitiba Digital', x: 60, y: 75 },
  { sigla: 'DGT MGF', nome: 'Maringá Digital', x: 56, y: 70 },
  { sigla: 'FOZ', nome: 'Foz do Iguaçu', x: 48, y: 74 },
  { sigla: 'LDB', nome: 'Londrina', x: 55, y: 69 },
  { sigla: 'MGF', nome: 'Maringá', x: 54, y: 70 },
  { sigla: 'SAO', nome: 'São Paulo', x: 60, y: 68 },
